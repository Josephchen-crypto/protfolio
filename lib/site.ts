...
export const siteDescription = {
  ...
  zh: "陈德基（Joseph Chen）个人作品集 - 拥有 12 年以上经验的 Android 工程师",
};
/** Facebook App ID for Open Graph fb:app_id. Create one at https://developers.facebook.com */
export const fbAppId = process.env.NEXT_PUBLIC_FB_APP_ID || undefined;
